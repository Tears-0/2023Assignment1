 ...
 */
const selectHorizontalMostCube = (isLeft: boolean, b: Blocks): Coord => {
 ...
 */
const selectVerticalMostCube = (isTop: boolean, b: Blocks): Coord => {
 ...
 */
const revertControl = (c: Movement): Movement => new Movement(c.horizontal==0 ? 0 : -c.horizontal,false,c.gravity==0 ? 0: -c.gravity, c.clockwise == 0? 0: -c.clockwise);
